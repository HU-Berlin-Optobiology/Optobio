...
//Folders need the "/" separator, not the standard Windows "\"

// These values are not stored, but within my MATLAB file sorting script, I had a tool which predicts these valies. Otherwise, go here: https://www.calculatorsoup.com/calculators/math/factors.php
// and get the most likely column/row numbers for the number of positions each section has
////////////////////////////////////////
// End of User Input
////////////////////////////////////////
Adding = true;
...
//Getting Base Name of Images based on used Method (everything before s1... if available)
if (Method == "sdc") {
